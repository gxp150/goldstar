// Self executing function keeps out of the gloabl scope (encapsulate) (function (){})()
const home = (function () {
    var homeMarkup = {
      // backticks alternate for using "" '' reduce the risk of errors
        template : `
        <div class="content-wrapper">
          <div class="project-group-wrapper">
             <div class="project-individual-wrapper">
                <div class="project-img-background"
                  style="background-image: url(images/aircon_1_bw.jpg)">
                </div>

                <div class="img-text-wrapper">
                  <div class="subtitle">About this project. <br />
